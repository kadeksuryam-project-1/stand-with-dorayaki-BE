...
func GetGoogleOauthToken(code string) (*GoogleOauthToken, error) {
	...
	values.Add("client_id", config.C.GoogleClientID)
	values.Add("client_secret", config.C.GoogleClientSecret)
	values.Add("redirect_uri", config.C.GoogleOAuthRedirectUrl)
